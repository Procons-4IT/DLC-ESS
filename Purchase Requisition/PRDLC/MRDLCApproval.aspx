<%@ Page Title="Material Return(DLC) Approval" Language="vb" AutoEventWireup="false"
    MasterPageFile="~/EMPRDLC.Master" CodeBehind="MRDLCApproval.aspx.vb" Inherits="PRDLC.MRDLCApproval" %>
            ...
            <table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                <tr>
                    <td height="30" align="left" colspan="2" valign="bottom" background="images/h_bg.png"
                        ...
                        <div>
                            &nbsp;
                            <asp:Label ID="Label3" runat="server" Text="Material Return(DLC) Approval" CssClass="subheader"
                                                                                ...
                                                                                <asp:GridView ID="grdRequestApproval" runat="server" CellPadding="4" ShowHeaderWhenEmpty="True"
                                                                                    ...
                                                                                    <Columns>
                                                                                        <asp:TemplateField HeaderText="Request No." Visible="False">
                                                                                            <ItemTemplate>
                                                                                                <div align="center">
                                                                                                    <asp:Label ID="lblRefCode" runat="server" Text='<%#Bind("DocEntry") %>'>
                                                                                                    </asp:Label>
                                                                                                </div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField HeaderText="Serial No." Visible="false">
                                                                                            <ItemTemplate>
                                                                                                <div align="center">
                                                                                                    <asp:Label ID="lblCode" runat="server" Text='<%#Bind("LineId") %>'> <%-- --%>
                                                                                                    </asp:Label>
                                                                                                </div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                ...
                                                                                <asp:GridView ID="grdSummary" runat="server" CellPadding="4" ShowHeaderWhenEmpty="true"
                                                                                    ...
                                                                                    <Columns>
                                                                                        <asp:TemplateField HeaderText="Request Code" Visible="false">
                                                                                            <ItemTemplate>
                                                                                                <div align="center">
                                                                                                    <asp:label ID="lblSCode" runat="server" Text='<%#Bind("LineId") %>' >
                                                                                                    </asp:Label>
                                                                                                </div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Goods Receipt" Visible="false">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &nbsp;<asp:Label ID="lblsgoods" runat="server" Text='<%#Bind("U_Z_DocRefNo") %>'></asp:Label>
                                                                                                </div>
