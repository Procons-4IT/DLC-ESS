<%@ Page Title="Material Return" Language="vb" AutoEventWireup="false" MasterPageFile="~/EMPRDLC.Master"
    CodeBehind="EmpMR.aspx.vb" Inherits="PRDLC.EmpMR" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="Update" runat="server">
        <ContentTemplate>
            <table width="99%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                ...
                <tr>
                    <td height="30" align="left" colspan="2" valign="bottom" background="images/h_bg.png"
                        ...
                        <div>
                            &nbsp;
                            <asp:Label ID="Label3" runat="server" Text="Material Return" CssClass="subheader"
                                            ...
                                            <tr>
                                                <td valign="top">
                                                    <ajx:TabContainer ID="TabContainer2" runat="server" ActiveTabIndex="0" CssClass="ajax__tab_yuitabview-theme"
                                                        Width="100%">
                                                        <ajx:TabPanel ID="TabPanel3" runat="server" HeaderText="Material Return">
                                                            <ContentTemplate>
                                                ...
                                                <tr>
                                                    <td valign="top">
                                                        <ajx:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" CssClass="ajax__tab_yuitabview-theme"
                                                            Width="100%">
                                                            <ajx:TabPanel ID="TabPanel5" runat="server" HeaderText="Material Return">
                                                                <ContentTemplate>
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="4" class="main_content">
                                                                        <tr>
                                                                            <td id="NewExpense" runat="server">
                                                                                ...
                                                                                <ajx:ModalPopupExtender ID="ModalPopupExtender6" runat="server"
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <asp:GridView ID="grdPRequestLines" runat="server" CellPadding="4"
                                                                                    CssClass="mGrid"
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Ref. Code" Visible="False">
                                                                                         ...
                                                                                         <asp:TemplateField HeaderText="DocNum" Visible="False">
                                                                                            <ItemTemplate>
                                                                                                <div align="center">
                                                                                                    <asp:Label ID="lblEDocCode" runat="server" Text='<%#Bind("DocNum") %>'>
                                                                                                    </asp:Label>
                                                                                                </div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        ...
                                                                                        <asp:TemplateField HeaderText="Approval Status">
                                                                                           ...
                                                                                           <asp:TemplateField HeaderText="Goods Receipt">
                                                                                            <ItemTemplate>
                                                                                                <div align="left">
                                                                                                    &nbsp;<asp:Label ID="lblEGoodRece" runat="server" Text='<%#Bind("GoodsReceipt") %>'></asp:Label>
                                                                                                </div>
                                                                                            </ItemTemplate>
                                                                                        </asp:TemplateField>
                                                                                        <asp:TemplateField>
                                                                                    ...
                                                                                    <HeaderStyle BackColor="Gray" HorizontalAlign="Center" ForeColor="White" 
                                                                                        Height="25px" CssClass="GridBG" />
                ...
                <tr>
                    <td>
                        <asp:Panel ID="PanelItemEntry" runat="server" BackColor="White" Style="display: none;
                            ...
                            <div>
                                <span class="sideheading" style="color: Green;">Material Return</span> <span style="float: right;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="3" class="main_content">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtorderqty" CssClass="txtbox" runat="server" autocomplete="off"
                                                    Width="210px" AutoPostBack="true" onkeypress="AllowNumbers(this);checkDec(this);"
                                        ...
                                        <tr>
                                            <td colspan="2" align="center">
                                                <br />
                                                <asp:Button ID="btnAdd" CssClass="btn" Width="85px" runat="server" Text="Save" CausesValidation="false" />
          ...
          <Triggers>
          <%--  <asp:PostBackTrigger ControlID="PanelItemEntry$Panel3$Panel1$btnAdd" />--%>
